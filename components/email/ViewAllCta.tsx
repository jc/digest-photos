...
import { MjmlButton, MjmlSection, MjmlColumn } from 'mjml-react';
...
export class ViewAllCta extends Component<ViewAllProps, {}> {
  ...
  button(url: string, text: string): JSX.Element {
    return (
  ...
  render() {
    if (this.props.remainingItems == 1) {
      ...
      return this.button(this.props.href, `View ${this.props.remainingItems} more photographs`);
    }
  }
}
